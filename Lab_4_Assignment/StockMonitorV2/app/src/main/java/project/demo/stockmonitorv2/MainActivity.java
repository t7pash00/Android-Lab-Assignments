package project.demo.stockmonitorv2;
...
import project.demo.stockmonitorv2.R;
...
public void addStockList(View view){
    EditText stockNameEdit = findViewById(R.id.stock_name);
    EditText stockIdEdit = findViewById(R.id.stock_name);
    String stockName = stockNameEdit.getText().toString();
    String stockId = stockIdEdit.getText().toString();
    stockMonitor(stockName, stockId );
}
